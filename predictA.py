...
def predict_from_array(features):
    ...
    """
    # 1. 加载归一化参数
    scaler_data = np.load("scaler_params_A12-67.npz")
    ...
    # 4. 加载模型并预测
    model = joblib.load("saved_model_A12-67.joblib")
