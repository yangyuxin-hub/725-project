...
class MecaVision : public QMainWindow {
    Q_OBJECT
public:
    MecaVision(QWidget *parent = 0);
    ~MecaVision();
...
private:
    ...
    static MecaVision* instance; // 单例模式

public:
    static MecaVision* getInstance(); // 单例模式

    QGraphicsScene *m_scene;

    static std::vector<double> image_features;
};
